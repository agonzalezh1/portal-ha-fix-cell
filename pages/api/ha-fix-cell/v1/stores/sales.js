    ...
    try {
        ...
        switch (req.method) {
            ...
            case 'GET':
                ...
                const result = await Stores.find({ _id : new Types.ObjectId(idStore)}, { dailySales: 1, cashFund: 1, contactInfo: 1, name: 1 });
                let spendAcc = 0;
                ...
                response = {
                    contactInfo: {
                        ...
                        whatsapp: result[0].contactInfo?.whatsapp,
                        phone: result[0].contactInfo?.phone,
                    },
                    name: result[0].name,
